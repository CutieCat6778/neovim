...
vim.opt.termguicolors = true -- Set termguicolors to enable highlight groups (default: false)                                        -- Which "horizontal" keys are allowed to travel to prev/next line (default: 'b,s')
...
local lcd_augroup = vim.api.nvim_create_augroup("user_lcd_on_bufenter", { clear = true })
